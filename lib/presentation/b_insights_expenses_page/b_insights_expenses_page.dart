...
class BInsightsExpensesPage extends StatefulWidget {
  const BInsightsExpensesPage({Key? key})
      : super(
          key: key,
        );

  @override
  BInsightsExpensesPageState createState() => BInsightsExpensesPageState();
}

class BInsightsExpensesPageState extends State<BInsightsExpensesPage>
    with AutomaticKeepAliveClientMixin<BInsightsExpensesPage> {
  @override
