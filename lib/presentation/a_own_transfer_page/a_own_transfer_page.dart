...
class AOwnTransferPage extends StatefulWidget {
  const AOwnTransferPage({Key? key})
      : super(
          key: key,
        );

  @override
  AOwnTransferPageState createState() => AOwnTransferPageState();
}

class AOwnTransferPageState extends State<AOwnTransferPage>
    with AutomaticKeepAliveClientMixin<AOwnTransferPage> {
