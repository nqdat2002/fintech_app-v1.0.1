...
class InsightIncome extends StatefulWidget {
  const InsightIncome({Key? key})
      : super(
    key: key,
  );

  @override
  _InsightIncome createState() => _InsightIncome();
}

class _InsightIncome extends State<InsightIncome> with AutomaticKeepAliveClientMixin<InsightIncome> {
  @override
