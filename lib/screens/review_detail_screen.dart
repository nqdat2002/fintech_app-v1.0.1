...
class _ReviewDetailsScreen extends State<ReviewDetailsScreen> {
                      ...
                      Align(
                          ...
                          child: Opacity(
                              ...
                              child: Container(
                                  ...
                                  child: Text(
                                      "An amount of exactly £250 is estimated to reach the account of Adrian UIUX in seconds.",
                                      maxLines: 2,
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        leading: AppbarLeadingImage(
            ...
            margin: EdgeInsets.only(left: 14.h, top: 15.v, bottom: 16.v),
            onTap: () {
            ...
            children: [
              Padding(
                  ...
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Adrian’s Account (500 GBP)".toUpperCase(),
                            style: CustomTextStyles
                                .titleSmallManropePrimaryContainer),
                        SizedBox(height: 6.v),
                        Opacity(
                            opacity: 0.5,
                            child: Text("4212423532",
                                style: CustomTextStyles
                                    .labelLargeSFProDisplayGray9000212)
                        )
                      ])),
  ...
  Widget _buildFullLegalName1(BuildContext context) {
    return CustomFloatingTextField(
        ...
        labelText: "Beneficiary’s account number",
        labelStyle: CustomTextStyles.labelLargeSFProTextTeal600,
        hintText: "Beneficiary’s account number",
  ...
  Widget _buildPrice(BuildContext context) {
    return CustomFloatingTextField(
        ...
        labelText: "You’re sending",
        labelStyle: CustomTextStyles.labelLargeSFProTextTeal600,
        hintText: "You’re sending",
        ...
        child: Column(
            ...
            children: [
              Opacity(
                  ...
                  child: Text("Our fee",
                      style: CustomTextStyles
                          .labelLargeSFProTextBlack900SemiBold_2)),
              SizedBox(height: 6.v),
              Text("£2.95", style: CustomTextStyles.labelLargeSFProTextTeal600)
            ]
        )
    );
  }
